...
//insert
  foreach ($planets as $NewPlanets)
  {
    $insert = "INSERT INTO `CSIS2440`.`PLANETS` (`PlanetName`, `PosX`, `PosY`, `PosZ`, `Desc`)"
      . " VALUES ('".$NewPlanets['name']."', '".$NewPlanets['x']."', '".$NewPlanets['y']."', '".$NewPlanets['z']."', '".$NewPlanets['description']."')";
  ...
  //     }
  //     else{
  //       echo $planets[$i]['name'] . " was given a space station<br>";
  //     }
  //   }

//Search
    // echo "<br>This is a table fo all planets<hr>";
